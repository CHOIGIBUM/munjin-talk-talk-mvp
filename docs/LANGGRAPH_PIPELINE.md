...
- `answers.redacted.json.payload.Qx.matched_slots`: IR 매칭 결과
- `answers.redacted.json.payload.Qx.pipeline_trace`: 실제 노드 실행 기록
- `llm_trace.redacted.json.payload.Qx.orchestration.active_path`: 노드 경로 요약
